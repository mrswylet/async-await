...
async function getFeedback(service) {
	let response = await axios.get('/feedback_list.json', {data: {service}});
	...
	response = await axios.get('/users_list.json',{ data: {users_id_list}});
